...
-- numérico; es decir que si tenemos dos valores con 4000, los rankea hipoteticamente como 5 a los dos y el siguiente lugar en el 
-- ranking será 7
...
rank() over(partition by cl.Clasificacion_credito order by saldo desc) as rrank_num
from clientes cl
join morosos mo
	on cl.Nombre = mo.Nombre; 
